...
if MODEL != 'alexnet':
    DATA_DIRECTORY = 'data/dataset/broden1_224'
    IMG_SIZE = 224
else:
...
if MODEL == 'resnet18':
    ...
    if DATASET == 'places365':
        MODEL_FILE = 'models/zoo/whole_densenet161_places365_python36.pth.tar'
        MODEL_PARALLEL = False
elif MODEL == 'resnet50':
    FEATURE_NAMES = ['layer4']
    if DATASET == 'places365':
        MODEL_FILE = 'models/zoo/whole_resnet50_places365_python36.pth.tar'
        MODEL_PARALLEL = False
